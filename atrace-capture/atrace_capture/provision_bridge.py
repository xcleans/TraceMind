...
``atrace-mcp/tool_provisioner.py`` re-exports this module so provisioning uses one
registry rooted at the monorepo (``atrace-mcp/bin/atrace-tool.jar``, bundled simpleperf).
"""
...
_root = monorepo_root()
_monorepo_path = _root / "_monorepo.py"
...
_bundled = _root / "atrace-mcp" / "simpleperf_toolkit" / "simpleperf"
