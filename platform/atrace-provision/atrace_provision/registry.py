...
from atrace_provision.bundled_paths import bundled_simpleperf_root
...
class ToolRegistry:
    ...
    def __init__(self, project_root: Path | None = None, bundled_toolkit: Path | None = None):
        ...
        resolved_toolkit = (
            bundled_toolkit if bundled_toolkit is not None else bundled_simpleperf_root()
        )
        self._toolkit = SimpleperfToolkitProvider(resolved_toolkit)
